<div class="up-footer">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-9">
                <p class="scb-cookies">All sites Contents TM and &copy 202 DC Entertainment, unless otherwise <span
                        class="text-primary"><a href="#">noted here</a></span>. All Right reserved. <br><span
                        class="text-primary"><a href="#">Cookies Setting</a></span></p>
            </div>
        </div>
    </div>
</div>